{{- define "metrics-aws-cloudwatch.region" -}}
{{- .Values.region -}}
{{- end -}}

{{- define "metrics-aws-cloudwatch.metricNamespace" -}}
{{- default "OpenChoreo/Metrics" .Values.metrics.namespace -}}
{{- end -}}

{{- define "metrics-aws-cloudwatch.logGroup" -}}
{{- default "/aws/openchoreo/metrics" .Values.metrics.logGroup -}}
{{- end -}}

{{- define "metrics-aws-cloudwatch.retentionServiceAccountName" -}}
