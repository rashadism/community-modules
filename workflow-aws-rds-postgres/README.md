...
| `git.tfPath` | No | `workflow-aws-rds-postgres/terraform` | Relative path inside the cloned repo to the directory containing the Terraform files |
  ...
  workflow:
    ...
    parameters:
      ...
      git:
        ...
        branch: "main"
        tfPath: "workflow-aws-rds-postgres/terraform"
      aws:
        region: "us-east-1"
